...
const SearchOptionInfiniteScrollDepartment = ({
  options,
  isLoading,
  totalItems,
  updateParams,
        ...
        {showOptions && (
          <>
            <div
              id="scrollableDiv"
              style={noDataStyle}
              className={`w-full absolute rounded-md top-[104%] left-0 z-10 ${(listOptions?.length === 0 || listOptions?.length < 8) ? "" : "shadow-md"}`}
            >
...
export default SearchOptionInfiniteScrollDepartment;
